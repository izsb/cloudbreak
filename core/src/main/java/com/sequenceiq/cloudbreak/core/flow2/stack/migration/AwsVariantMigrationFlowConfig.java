...
import static com.sequenceiq.cloudbreak.core.flow2.stack.migration.AwsVariantMigrationEvent.CHANGE_VARIANT_EVENT;
import static com.sequenceiq.cloudbreak.core.flow2.stack.migration.AwsVariantMigrationEvent.CREATE_RESOURCES_EVENT;
import static com.sequenceiq.cloudbreak.core.flow2.stack.migration.AwsVariantMigrationEvent.DELETE_CLOUD_FORMATION_EVENT;
import static com.sequenceiq.cloudbreak.core.flow2.stack.migration.AwsVariantMigrationFlowState.*;
...
public class AwsVariantMigrationFlowConfig extends AbstractFlowConfiguration<AwsVariantMigrationFlowState, AwsVariantMigrationEvent>
    ...
    private static final FlowEdgeConfig<AwsVariantMigrationFlowState, AwsVariantMigrationEvent> EDGE_CONFIG =
            new FlowEdgeConfig<>(INIT_STATE, FINAL_STATE, AWS_VARIANT_MIGRATION_FAILED_STATE, AWS_VARIANT_MIGRATION_FAIL_HANDLED_EVENT);
