...
public final class PublicEndpointManagementProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getCertificatesBytes().isEmpty()) {
      ...
      if (!getRequestingServiceBytes().isEmpty()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      result = result && getAccountId()
          .equals(other.getAccountId());
      result = result && getCertificates()
          .equals(other.getCertificates());
      result = result && reason_ == other.reason_;
      result = result && getRequestingService()
          .equals(other.getRequestingService());
      result = result && unknownFields.equals(other.unknownFields);
      return result;
    }
